...
namespace Client
{
    ...
    public class KeyBindSettings
    {
        ...
        public void New(List<KeyBind> list)
        {
            ...
            list.Add(InputKey);
            InputKey = new KeyBind { Group = "Belt", Description = "Belt Slot 0", function = KeybindOptions.Belt0, RequireAlt = 2, RequireShift = 2, RequireTilde = 2, RequireCtrl = 2, Key = Keys.D0 };
            list.Add(InputKey);
            InputKey = new KeyBind { Group = "Belt", Description = "Belt Slot 0 Alt", function = KeybindOptions.Belt0Alt, RequireAlt = 2, RequireShift = 2, RequireTilde = 2, RequireCtrl = 2, Key = Keys.NumPad0 };
            list.Add(InputKey);
